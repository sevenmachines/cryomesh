...
void SequencerGeneric::on_start_element(const Glib::ustring& name, const AttributeList& attributes) {
	...
	for (xmlpp::SaxParser::AttributeList::const_iterator iter = attributes.begin(); iter != attributes.end(); ++iter) {
		try {
			...
			std::cerr << "SequencerGeneric::on_start_element(): Exception caught while converting name for std::cout: "
					<< ex.what() << std::endl;
		}
		...
		try {
			...
			std::cerr << "SequencerGeneric::on_start_element(): Exception caught while converting value for std::cout: "
					<< ex.what() << std::endl;
		}
...
void SequencerGeneric::on_comment(const Glib::ustring& text) {
	try {
		...
		std::cerr << "SequencerGeneric::on_comment(): Exception caught while converting text for std::cout: "
				<< ex.what() << std::endl;
	}
}
...
void SequencerGeneric::on_warning(const Glib::ustring& text) {
	try {
		std::cout << "SequencerGeneric::on_warning(): " << text << std::endl;
	} catch (const Glib::ConvertError& ex) {
		std::cerr << "SequencerGeneric::on_warning(): Exception caught while converting text for std::cout: "
				<< ex.what() << std::endl;
	}
}
...
void SequencerGeneric::on_error(const Glib::ustring& text) {
	try {
		std::cout << "SequencerGeneric::on_error(): " << text << std::endl;
	} catch (const Glib::ConvertError& ex) {
		std::cerr << "SequencerGeneric::on_error(): Exception caught while converting text for std::cout: " << ex.what()
				<< std::endl;
	}
}
...
void SequencerGeneric::on_fatal_error(const Glib::ustring& text) {
	try {
		std::cout << "SequencerGeneric::on_fatal_error(): " << text << std::endl;
	} catch (const Glib::ConvertError& ex) {
		std::cerr << "SequencerGeneric::on_characters(): Exception caught while converting value for std::cout: "
				<< ex.what() << std::endl;
	}
}
...
std::ostream & operator<<(std::ostream& os, const SequencerGeneric & obj) {
	...
	{
		std::list<boost::shared_ptr<SequencerGeneric::NodeEntry> >::const_iterator it_nodeEntries =
				obj.nodeEntries.begin();
		const std::list<boost::shared_ptr<SequencerGeneric::NodeEntry> >::const_iterator it_nodeEntries_end =
				obj.nodeEntries.end();
